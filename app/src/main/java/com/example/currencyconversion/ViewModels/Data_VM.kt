...
import com.example.currencyconversion.Repository
import dagger.hilt.android.lifecycle.HiltViewModel
import kotlinx.coroutines.launch
import javax.inject.Inject

@HiltViewModel
class Data_VM @Inject constructor(private val repository: Repository) : ViewModel(){
    ...
    fun getExchangeData(apiKey: String) = viewModelScope.launch {
        repository.getExchangeData( apiKey).collect { values: NetworkResult<ResponseExchangeList> ->
